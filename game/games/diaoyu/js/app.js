var HelloWorldLayer = cc.Layer.extend({
    ctor:function () {
        ...
        self.wxData = {
            "appId": "", // 服务号可以填写appId
            "imgUrl" : 'https://test.buzhoushan.top/game/games/diaoyu/logo.png',
            "link" : 'https://test.buzhoushan.top/game/games/diaoyu/',
        ...
        WeixinApi.ready(function(Api) {
            ...
            var wxCallbacks = {
                ...
                confirm : function(resp) {
                    ...
                    //window.location.href='https://test.buzhoushan.top/game/';
                    // alert("分享成功");
                },
                // 整个分享过程结束
                all : function(resp) {
                    ...
                    // alert("分享结束");
                    if(self.isGameOver){
                        if(window.location) window.location.href = "https://test.buzhoushan.top/game/games/diaoyu/";
                    }
                }
            };
    ...
    gameOver: function(){
        ...
        layerMask.delay(0.5).then(function(){
            ...
            var share = cc.createSprite('https://test.buzhoushan.top/game/games/diaoyu/share.png', {
                anchor: [1.0, 1.0],
                xy: [720, 1280],
                opacity: 0,
                scale: 0.5

var HelloWorldLayer = cc.Layer.extend({
    ctor:function () {
        ...
        self.wxData = {
            "appId": "", // 服务号可以填写appId
            "imgUrl" : 'https://buzhoushan.github.io/game/games/diaoyu/logo.png',
            "link" : 'https://buzhoushan.github.io/game/games/diaoyu/',
        ...
        WeixinApi.ready(function(Api) {
            ...
            var wxCallbacks = {
                ...
                all : function(resp) {
                    ...
                    // alert("分享结束");
                    if(self.isGameOver){
                        if(window.location) window.location.href = "https://buzhoushan.github.io/game/games/diaoyu/";
                    }
                }
            };
    ...
    gameOver: function(){
        ...
        layerMask.delay(0.5).then(function(){
            ...
            var share = cc.createSprite('https://buzhoushan.github.io/game/games/diaoyu/share.png', {
                anchor: [1.0, 1.0],
                xy: [720, 1280],
                opacity: 0,
                scale: 0.5

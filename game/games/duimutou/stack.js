...
var tite="";
	var DFW = {
		appId: "",
		TLImg: "https://test.buzhoushan.top/game/games/duimutou/icon.png",
		url: "https://test.buzhoushan.top/game/games/duimutou/",
...
function updateShare(stscore) {
	imgUrl = 'https://test.buzhoushan.top/game/games/duimutou/i/icon.png';
	lineLink = 'https://test.buzhoushan.top/game/games/duimutou';
